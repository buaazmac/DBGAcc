...
protected:
   ...
   /* [ZMAC] Added statistics for PIM offloading */
   UInt64 m_instruction_count_pim;

   ComponentTime m_elapsed_time_pim;
   ComponentTime m_idle_elapsed_time_pim;
   ComponentTime m_lll_time;
   ComponentTime m_lll_time_pim;
