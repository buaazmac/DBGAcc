...
private:
   ...
   // [ZMAC] Instruction execution & memory access breakdown statistics for PIM offloading
   uint64_t m_exe_latency, m_load_latency, m_store_latency,
            m_exe_latency_pim, m_load_latency_pim, m_store_latency_pim;
   uint64_t m_exe_cp_latency, m_load_cp_latency, m_store_cp_latency,
            m_exe_cp_latency_pim, m_load_cp_latency_pim, m_store_cp_latency_pim;
};
