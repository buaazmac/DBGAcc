...
class AtomicBitVector {
 ...
 public:
  ...
  std::uintptr_t get_begin() { return reinterpret_cast<std::uintptr_t>(data_array_.data()); }
  std::uintptr_t get_end() { return reinterpret_cast<std::uintptr_t>(&(data_array_[(size_ + kBitsPerWord - 1) / kBitsPerWord - 1])); }
